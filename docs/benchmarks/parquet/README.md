...
**Latest @ 1M rows:** [`../parquet-hits-1m/serve-hot.md`](../parquet-hits-1m/serve-hot.md) (Q1–43 hot sum ~5.44s)  
**Validation log:** [`validation-1m.md`](validation-1m.md) — 43/43 pass vs DuckDB on same slice.
